...
router.get("/facilities/:facilityId/reviews", facilityController.getFacilityReview);
...
router.post("/facilities/:facilityId/review", isLogin, facilityController.createFacilityReview);
