...
export class ClubRepository {
    addClub = async (clubData, userId, regionId, sportTypeId) => {
    ...
    updateClub = async (clubData, clubId, regionId, sportTypeId) => {
        return await prisma.$transaction(async (tx) => {
    ...
    findClubs = async (regionId, ageGroup, keyword, sportId, cursor) => {
